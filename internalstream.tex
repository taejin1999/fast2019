...
%\vspace{-7pt}
\hfill
\subfloat[RocksDB: compaction]{\includegraphics[width=0.19\textwidth]{figure/type_6}}% data from 4/03040047
	\hspace{2pt}
\subfloat[RocksDB: L2]{\includegraphics[width=0.19\textwidth]{figure/type_4}}  
\hfill
\vspace{-1pt}
\subfloat[sqlite: data files]{\includegraphics[width=0.19\textwidth]{figure/sqlite_long_LBA}}
	\hspace{2pt}
\subfloat[gcc: result files]{\includegraphics[width=0.19\textwidth]{figure/compile_long}}
%\vspace{-10pt}
