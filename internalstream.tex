...
(e.g., Figs.~\ref{fig:types_and_PCs}(a), ~\ref{fig:types_and_PCs}(e), and
~\ref{fig:types_and_PCs}(g)).
...
\begin{figure}[!t]
\centering
\subfloat[RocksDB: L2 Compaction]{\includegraphics[width=0.19\textwidth]{figure/type_4}}  % data from 4/03040047
	\hspace{10pt}
\subfloat[RocksDB: L4 Compaction]{\includegraphics[width=0.19\textwidth]{figure/type_6}}
...
object files/executable files after a Linux build was completed
