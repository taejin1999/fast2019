...
As explained in Section 3, since both RocksDB and Cassandra are based on the
...
We compared IOPS values of three existing techniques with \textsf{\small PCStream}.
