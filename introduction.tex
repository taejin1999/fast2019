...
~\cite{DAC, GCGreedy, GCVictim, GCTTFlash, HotCold}.  
...
For given logical streams, \textsf{\small PCStream} groups ones with similar data lifetimes 
...
by reducing the average WAF by 49\%.
