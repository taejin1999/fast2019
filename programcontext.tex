...
%\vspace{-10pt}
	...
	\hspace{4pt}
	\subfloat[RocksDB: Compaction]{\includegraphics[width=0.22\textwidth]{figure/pc_3}}  
	\hspace{2pt}
	\subfloat[TBD]{\includegraphics[width=0.1\textwidth]{figure/type_6}}% data from 4/03040047
	\hfill
