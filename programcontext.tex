...
%\vspace{-10pt}
	...
	\hspace{2pt}
	\subfloat[RocksDB: L2 Compaction]{\includegraphics[width=0.22\textwidth]{figure/type_4}}  
	\hspace{2pt}
	\subfloat[RocksDB: L4 Compaction]{\includegraphics[width=0.22\textwidth]{figure/type_6}}% data from 4/03040047
	\hfill
	\subfloat[SQLite: logging]{\includegraphics[width=0.22\textwidth]{figure/sqlite_short_LBA}}
	\hspace{2pt}
	\subfloat[SQLite: data files]{\includegraphics[width=0.22\textwidth]{figure/sqlite_long_LBA}}
	\hspace{2pt}
	\subfloat[GCC: temp files]{\includegraphics[width=0.22\textwidth]{figure/compile_short_PC}}
	\hspace{2pt}
	\subfloat[GCC: result files]{\includegraphics[width=0.22\textwidth]{figure/compile_long}}
%\vspace{-7pt}
...
activities of SQLite and GCC.
 We also
see that the logging activity is successfully identified by PCs. 
\end{comment}
