...
%	\vspace{-10pt}
	...
	%\vspace{-14pt}
	%\hfill
	\subfloat[with the frame pointer.]{\includegraphics[width=0.22\textwidth]{figure/getpc_new1}}
	\hspace{4pt}
	\subfloat[without the frame pointer.]{\includegraphics[width=0.23\textwidth]{figure/getpc2}}
	%\vspace{-9pt}
