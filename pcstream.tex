...
corresponding stream ID\endnote{ We call {\it i} the stream ID of $S_i$.} from
...
number of streams, the number of unique PCs can be quite large \note{(e.g.,
20)}.  For grouping PCs with similar lifetimes, the PC2Stream mapper module
...
short-lived data will not be mixed with short-lived data in the main stream}.
