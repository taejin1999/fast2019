...
\begin{figure}[t]
	...
	\hfill
	\vspace{2pt}
	\subfloat[Lifetime patterns over time for chunk A]{\includegraphics[width=0.21\textwidth]{figure/lifetime_in_chunk}} % data from 0/03031641
	\hspace{10pt}
	\subfloat[Lifetime patterns over time for chunk B]{\includegraphics[width=0.21\textwidth]{figure/lifetime_in_chunk3}}
...
\begin{figure}[t]
	...
	\includegraphics[angle=90, width=0.6\linewidth]{figure/stream_perf}
	%\vspace{-9pt}
	\caption{The performance of a multi-streadmed SSD varying number of streams.} 
...
In the example, application has 4 distinct lifetime characteristics.
