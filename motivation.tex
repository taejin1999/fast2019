...
For example, 
in both \textsf{\small ManualStream\endnote{For brevity, we denote the manual stream allocation
method used in ~\cite{MultiStream} by \textsf{\small ManualStream}.}}~\cite{MultiStream} and 
